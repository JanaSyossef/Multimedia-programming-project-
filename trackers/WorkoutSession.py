...
class WorkoutSession:
    ...
    @staticmethod
    def saveSessions():
        DataStore.DataStore.saveData(WorkoutSession.dataStoreName, WorkoutSession.all_sessions)

    @staticmethod
    def loadSessions():
        return DataStore.DataStore.loadData(WorkoutSession.dataStoreName)
    ...
    def endAllSessions(cls):
        for session in cls.all_sessions:
            session.endSession()
        cls.saveSessions()
        DataStore.DataStore.flatten_for_analysis(cls.all_sessions)
